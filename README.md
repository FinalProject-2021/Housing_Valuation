...
We also employed a number of approaches to time series modelling, including a melt approach [IS THIS A REASONABLE WAY TO PUT THIS], ARIMA, and VAR (vector autoregressive modelling). VAR has the advantage of allowing the use of multiple features.
